...
INSERT INTO `__new_settings`("id", "language", "keywords", "adult", "toastPosition") SELECT "id", "language", "keywords", "adult", "toastPosition" FROM `settings`;--> statement-breakpoint
