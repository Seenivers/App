...
- add Authorization header to fetchData for TMDB API requests ([4978852](https://github.com/Seenivers/App/commit/4978852e16beee0c163ba1a604ecf77af478773a))
- adjust badge styling for release date display ([a466b20](https://github.com/Seenivers/App/commit/a466b2013d220301589d4f6ef7f340f3e0b69da8))
- **deps:** update dependency drizzle-orm to ^0.44.2 ([d4202fa](https://github.com/Seenivers/App/commit/d4202fa76d64c7a4fdd5002e36841da2e40317ca))
- **deps:** update dependency hls.js to ^1.6.5 ([803c92f](https://github.com/Seenivers/App/commit/803c92f7d481cf41989ec776ba490c2876d775d1))
- ensure correct type assertion for JSON response in parseResponse function ([750ce32](https://github.com/Seenivers/App/commit/750ce3202e8520da1d9d722e12ed03a47ddc5253))
- move watched status button to the correct position in episode and movie pages ([bcc4a50](https://github.com/Seenivers/App/commit/bcc4a50d57f1fa1fcab233e6cc77ffed713235ac))
- refactor getAll method to accept only IDs and simplify missing items retrieval ([ba35df5](https://github.com/Seenivers/App/commit/ba35df5b4462d022b6f5010bc793a3e9cd549b42))
- remove wantsToWatch field from collections schema ([a967b73](https://github.com/Seenivers/App/commit/a967b7329de35646ca6da094ab17e759e867690d))
- remove wantsToWatch property from collection retrieval ([24a2efd](https://github.com/Seenivers/App/commit/24a2efd1b7085460c75c23fc4c17204e1cbfb3b2))
- rename tmdbSessionId to tmdbAccountID in settings schema ([3ce76ef](https://github.com/Seenivers/App/commit/3ce76efa3ca6a63299e3550434702206a5d89cdc))
- replace console.error with error handling in postToken and postAccessToken functions ([a745b7f](https://github.com/Seenivers/App/commit/a745b7fbbe1023818248adbe3e81a772ea5a8739))
- update guest stars display in episode page and add translations ([67a4023](https://github.com/Seenivers/App/commit/67a40233df0291d7bf614518d13e663a3583dc9c))
- update serie.getAll call to accept remote series IDs directly ([3b49dd5](https://github.com/Seenivers/App/commit/3b49dd5c1ebcfbfe5d98746d4661993f1ab4212c))
- update settingsDB and settings with tmdbAccountID during authentication ([7811ddc](https://github.com/Seenivers/App/commit/7811ddc9712fbb6badf88491060da9ee2290f35a))
- update TMDB authentication handling to store access token and account ID ([a6f971a](https://github.com/Seenivers/App/commit/a6f971ab4bd12733c75392d789b0fc6063b9f8e7))
- update wantsToWatch status using movie.update instead of collection.update ([e500e7b](https://github.com/Seenivers/App/commit/e500e7b4483556ec0763e7c0ec3971cc9aa736f9))

### Features

- add 'Aqua' theme to the themes list in app configuration ([aeb78ac](https://github.com/Seenivers/App/commit/aeb78ac56f8da573d8e6e4377b6226bbac97eb6c))
- add 'Bumblebee' theme to the themes list in app configuration ([745d9c7](https://github.com/Seenivers/App/commit/745d9c727dda00e7be9e193cf2becc4dcc448359))
- add 'Corporate' theme to the themes list in app configuration ([edcd0f0](https://github.com/Seenivers/App/commit/edcd0f015eac7794c3cc223b48a11e26414be918))
- add 'Cupcake' theme to the themes list in app configuration ([b0eac44](https://github.com/Seenivers/App/commit/b0eac44bbbf2f1e2b7e429f5268a59ea6c631637))
- add 'Cyberpunk' theme to the themes list in app configuration ([a5767b1](https://github.com/Seenivers/App/commit/a5767b10b53668306f0d209417df64dff0882fb2))
- add 'Dim' theme to the themes list in app configuration ([723274a](https://github.com/Seenivers/App/commit/723274a5bce1e1e3da7f7e3eebb57ead29833823))
- add 'Dracula' theme to the themes list in app configuration ([be06749](https://github.com/Seenivers/App/commit/be06749473b8f917003e3579ba9185f4ba9c5693))
- add 'Emerald' theme to the themes list in app configuration ([7f98e0a](https://github.com/Seenivers/App/commit/7f98e0a80a9a047bb5e7635d43f0492f0a9a99d4))
- add 'Forest' theme to the themes list in app configuration ([5701b2c](https://github.com/Seenivers/App/commit/5701b2c2b397a51117a36b99702498670968abf2))
- add 'Halloween' theme to the themes list in app configuration ([70e0f29](https://github.com/Seenivers/App/commit/70e0f29d409a80caef30d54ffec2dbe35c35ce57))
- add 'Night' theme to the themes list in app configuration ([59b0365](https://github.com/Seenivers/App/commit/59b03654a31181211e13702a5b10a6df5050e42f))
- add 'Nord' theme to the themes list in app configuration ([85adf73](https://github.com/Seenivers/App/commit/85adf73607519d9585ba2380205f10527e2c80ff))
- add 'Retro' theme to the themes list in app configuration ([4c1e770](https://github.com/Seenivers/App/commit/4c1e770f3a2c93ffc0871c6fe8e212176033c438))
- add 'Sunset' theme to the themes list in app configuration ([c5c90ab](https://github.com/Seenivers/App/commit/c5c90ab2eeaca49bc16889bb4878d27de17f396e))
- add 'Synthwave' theme to the themes list in app configuration ([fc1df76](https://github.com/Seenivers/App/commit/fc1df7630a13fe388e89bb60acdb94b38d6300dc))
- add 'Valentine' theme to the themes list in app configuration ([6977ad3](https://github.com/Seenivers/App/commit/6977ad394a6e6ce2c4961b34222c8337a55972ad))
- add 'Wireframe' theme to the themes list in app configuration ([f278a35](https://github.com/Seenivers/App/commit/f278a35439dffcbb83502075daeb60d5fe7278d8))
- add card component for displaying media items ([fd9aff3](https://github.com/Seenivers/App/commit/fd9aff36f6dc64ac6821753cb35a607ac4738044))
- add folder existence check and error message for watch paths input ([f2338b4](https://github.com/Seenivers/App/commit/f2338b4b70aed0c40d9c715b728cdd1b6d12887e))
- add getToken function to fetch TMDB token ([2b84038](https://github.com/Seenivers/App/commit/2b84038ac2d14f7eb667fccefb9e26fdd91e3894))
- add link to watchlist in the navbar ([cc9cd4c](https://github.com/Seenivers/App/commit/cc9cd4cbe9111abc5a63705a61aa4da85d08744c))
- add Navbar, ProgressBar, and Updater components with routing updates ([aac681a](https://github.com/Seenivers/App/commit/aac681a060c7b05ffa7642b8a1939caf51784456))
- add postWatchlist function to handle adding/removing items from the user's watchlist ([a22431f](https://github.com/Seenivers/App/commit/a22431febcf4d5b7465882df8be1deb931e7f999))
- add postWatchlist functionality to movie and tv routes for updating watchlist status ([6854beb](https://github.com/Seenivers/App/commit/6854beb6ab82ec34bb43f238c2a0e9b8a766d6ed))
- add rating columns to episode, movies, and series tables; update settings and collection schema ([d1271e2](https://github.com/Seenivers/App/commit/d1271e2eb6eacb8719104bd883309fb506adbe4e))
- add rating field to episode, movie, and serie schemas ([2d10429](https://github.com/Seenivers/App/commit/2d1042944672f8b48e338a0ac302c31b2c821f17))
- add success toast notification for TMDB authentication completion ([be6690f](https://github.com/Seenivers/App/commit/be6690fabbd095441369ae9b57bebbeba96588f3))
- add TMDB authentication button in settings with session tracking ([71eb66d](https://github.com/Seenivers/App/commit/71eb66da829d2c2da2cbdf534eacaceb067b726d))
- add TMDB authentication route with error handling and session management ([a000568](https://github.com/Seenivers/App/commit/a00056847fb9f8600d862e08653a4d8a32da9f1f))
- add TMDBPostResult interface and create watchlist type definitions ([c411087](https://github.com/Seenivers/App/commit/c411087b95a813b02177a4a048fd56bdb0706263))
- add tooltip for double-click delete action in watchlist ([164351b](https://github.com/Seenivers/App/commit/164351b30f408ba32d8980dbce0bf24093118f40))
- add user rating functionality to episode, movie, and TV pages ([1ea9800](https://github.com/Seenivers/App/commit/1ea9800825de91be5b2f771896cd57193b321e4c))
- add warning kind to reauthentication confirmation dialog ([1730d68](https://github.com/Seenivers/App/commit/1730d686a43f3ee456054c0d191599d34a249adc))
- add watchlist and sync watchlist translations to locale files ([ce3096e](https://github.com/Seenivers/App/commit/ce3096ea6175100c56f5791d77245d60da6a5440))
- call syncWatchlist function during component mount to ensure watchlist is up-to-date ([4f834aa](https://github.com/Seenivers/App/commit/4f834aa6d985ab5ee89fc62b678d338a7b152ca5))
- define Token and Session interfaces for authentication ([fb8a527](https://github.com/Seenivers/App/commit/fb8a527479eee7a8b28ea593dd7de3af8f1362f0))
- disable TMDB authentication button when session ID is present ([c88f3cf](https://github.com/Seenivers/App/commit/c88f3cfa370a32a7cc140dd91d16f4fde9a83f7e))
- enhance logging setup for main window in layout component ([8218ba8](https://github.com/Seenivers/App/commit/8218ba8b87e01df9d9099dd28710e3ab90e4272e))
- extend the interfaces for RequestToken and AccessToken in authentication ([9145fb1](https://github.com/Seenivers/App/commit/9145fb1fd423ec6bfd7e60055057ca330f585a1a))
- implement getWatchlist function to fetch user's watchlist ([fe712a9](https://github.com/Seenivers/App/commit/fe712a998f8672289945584e445315f3e64066ac))
- implement postSession function to create TMDB session ([4a5d43e](https://github.com/Seenivers/App/commit/4a5d43eb0afbe3afccc28231c02439be9af4d212))
- implement rating component with dynamic star inputs ([7bd63bb](https://github.com/Seenivers/App/commit/7bd63bbddf1ddaba8cc70bf9e95a68c242525c05))
- implement syncWatchlist function to synchronize local watchlist with TMDB ([b1391b6](https://github.com/Seenivers/App/commit/b1391b6e4492e69193e9bd3426417d1689282425))
- implement TMDB authentication flow using Webview ([80f834d](https://github.com/Seenivers/App/commit/80f834d2df305804255e7c80e695f4dace1c4dd5))
- implement watchlist page with movie and series retrieval ([3a8293c](https://github.com/Seenivers/App/commit/3a8293c60b2b31e60091b0604bbbc928a4cf6160))
- replace remove button with Close SVG icon and adjust styles ([ec7e022](https://github.com/Seenivers/App/commit/ec7e022e46c8ede11807a3e99a1a9e23f81c0512))
- track changes in watch paths input and add dirty state on add button click ([fc4d223](https://github.com/Seenivers/App/commit/fc4d2239a072801f3b1f160b8dcdbb7b8da12a9d))
- update authentication types and refactor token handling in TMDB API ([cb8cdad](https://github.com/Seenivers/App/commit/cb8cdad9adb2b55c7256b4ee2e88bb9903160ca1))
- update serie watched status to reset wantsToWatch when marked as watched ([229f2c2](https://github.com/Seenivers/App/commit/229f2c2a9e82a2432be1973859829b462318427a))
- update TMDB authentication button and add reauthentication confirmation ([26ce683](https://github.com/Seenivers/App/commit/26ce68368305053d39a6e75627d14bc8e0dd4f64))
- update TMDB authentication labels in settings and localization files ([66b872b](https://github.com/Seenivers/App/commit/66b872b84baee2201422921390d038279348da59))
- update TMDB authentication to use access token instead of session ID ([13987bc](https://github.com/Seenivers/App/commit/13987bcce61999134a658a75ad22469bb321d127))
